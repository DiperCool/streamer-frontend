...
import { Camera, Upload, Users, Home, Heart, User, Settings } from "lucide-react"
        ...
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarNav>
              ...
              <SidebarNavItem icon={<Settings />} active>
                Settings
              </SidebarNavItem>
            </SidebarNav>
          </SidebarContent>
        ...
        <div className="flex-1 container mx-auto px-4 py-8">
          ...
          <Tabs defaultValue="profile" className="w-full">
            <TabsList className="grid w-full grid-cols-7 bg-gray-800 mb-8">
              ...
              <TabsTrigger value="stream" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Stream URL and Key
              </TabsTrigger>
              <TabsTrigger value="security" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Security
              </TabsTrigger>
              <TabsTrigger value="preferences" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Preferences
              </TabsTrigger>
              <TabsTrigger value="notifications" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Notifications
              </TabsTrigger>
              <TabsTrigger value="connections" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Connections
              </TabsTrigger>
              <TabsTrigger value="developer" className="data-[state=active]:bg-green-600 data-[state=active]:text-white">
                Developer
              </TabsTrigger>
            </TabsList>
