...
export default function StreamInfoSettingsPage() {
  return (
    <div className="space-y-8">
      ...
      <Card className="bg-gray-800 border-gray-700 flex-1 flex flex-col"> {/* Add flex-1 flex flex-col to Card */}
        <CardHeader>
          <CardTitle className="text-white">Current Stream Details</CardTitle>
        </CardHeader>
        <CardContent className="p-0 flex-1 flex flex-col"> {/* Add flex-1 flex flex-col to CardContent */}
          <StreamInfoWidget />
        </CardContent>
      </Card>
    </div>
