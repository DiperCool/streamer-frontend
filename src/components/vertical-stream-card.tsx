...
export const VerticalStreamCard: React.FC<VerticalStreamCardProps> = React.memo(
  ({ stream, onClick, selected }) => {
    ...
    return (
      <div
        className={cn(
          "group relative w-full aspect-[4/3] cursor-pointer rounded-lg overflow-hidden bg-gray-800 hover:bg-gray-700 transition-colors duration-200 flex-grow", // Removed h-32, added aspect-[4/3] and flex-grow
